...
public class TabbedTables extends Application {
    ...
    /**
     * Create the application menu bar. This may need to go into a separate class
     * rather then be generated by a helper method. If it grows too large then it
     * will be.
     * 
     * @param stage - Application's Stage instance.
     * @return - the MenuBar instance with everything built up.
     */
